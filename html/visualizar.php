...
<body>
    ...
    <main>
        <?php 
            // Verifica se um ID foi enviado via GET
            if(isset($_GET['id'])) {
        ...
        <div class="container-visualizar">
            <!-- Imagem do produto -->
            <img src="../imagens/img_produtos/<?php echo $PRODUTO['PROD_IMAGE']?>.jpg" alt="Imagem do produto" class="img-visualizar">
            <div class="textos-visualizar">
                <div class="textos-top">
                    <!-- Nome do produto -->
                    <h3 class="nome-produto"><?php echo  $PRODUTO['PROD_NAME'] ?></h3>
                    <!-- Descrição do produto -->
                    <p class="descricao-produto"><?php echo  $PRODUTO['PROD_DESC'] ?></p>
                    <!-- Preço do produto -->
                    <p class="valor-produto">R$<?php echo  $PRODUTO['VALOR']?></p>
                </div>
                ...
                <form action="../php/acoes.php" method="post">
                    ...
                    <button type="submit" class="botao-adicionar" name="add_cart"
                        value="<?php echo $PRODUTO['ID_PROD']?>">Adicionar ao carrinho</button>
